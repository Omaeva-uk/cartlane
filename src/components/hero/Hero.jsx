    ...
    <div className="h-screen max-w-[1200]  pt-8 lg:px-16 px-7  mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 max-md:gap-10 mt-5 md:mt-20 mx-auto">
            <div className="max-w-md mt-5">
                ...
                <PrimaryButton classname="mt-5 mb-7 primary-btm fade-in" text="Join our platform now" />
            ...
            <div className=" relative">
                ...
                <div className="mr-20 hero-img-animate md:mr-10">
                    <Image src="/assets/hero/main-img-2.png" className="md:scale-[1.5] max-sm:max-w-[100%] max-w-[92%]" width={500} height={544} alt="Cartlane app" />
                </div>
